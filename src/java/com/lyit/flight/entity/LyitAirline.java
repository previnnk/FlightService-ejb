...
@NamedQueries({
    ...
    @NamedQuery(name = "LyitAirline.findByAirlineCode", query = "SELECT l FROM LyitAirline l WHERE l.airlineCode = :airlineCode")})
public class LyitAirline implements Serializable {
    ...
    public String toString() {
        return "com.lyit.flight.entity.LyitAirline[ id=" + id + " ]";
    }
