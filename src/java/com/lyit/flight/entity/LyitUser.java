...
@NamedQueries({
    ...
    @NamedQuery(name = "LyitUser.findByEnabled", query = "SELECT l FROM LyitUser l WHERE l.enabled = :enabled"),
    @NamedQuery(name = "LyitUser.findByRole", query = "SELECT l FROM LyitUser l WHERE l.role = :role")})
