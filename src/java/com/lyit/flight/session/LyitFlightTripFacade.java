 ...
 */
@Stateless
public class LyitFlightTripFacade extends AbstractFacade<LyitFlightTrip> implements LyitFlightTripFacadeLocal {
   // @PersistenceContext(unitName = "ie.lyit.project.dashboard_LyitFlightCheckerBoardEA-ejb_ejb_1.0-SNAPSHOTPU")
    ...
    public LyitFlightTripFacade() {
        super(LyitFlightTrip.class);
    }
